...
from app.core.messaging import drain_email_outbox, promote_due_scheduled
...
def run_outbox_pass() -> dict[str, int]:
    ...
    return {"tenants": tenants, "promoted": promoted, "emails_attempted": attempted}
...
async def outbox_loop() -> None:
    ...
    while True:
        try:
            ...
            if stats["emails_attempted"] or stats["promoted"]:
